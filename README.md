...
If you want to test that you can register as a new user (with an e-mail verification), you might use [Nada](https://getnada.com/). BTW sample code does not sending emails you have to implement that by yourself :-).
